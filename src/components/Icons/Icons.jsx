/**
 * Inline SVG icon set — keeps the bundle tiny and lets us style via currentColor.
 */
...
export function GraphIcon({ size = 18 }) {
  return (
    <svg
      width={size}
      height={size}
...
export function CubeIcon({ size = 18 }) {
  return (
    <svg
      width={size}
      height={size}
