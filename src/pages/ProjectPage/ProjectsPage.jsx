      ...
      <section className={styles.mainSection}>
        <div className={styles.container}>
          <div className={styles.controlsInner}>
            {/* Animasi pencarian dengan class reveal-slide-up milik Anda */}
            <NativeReveal className={`${styles.searchWrap} reveal-slide-up`}>
              <SearchIcon size={16} />
              <input
                type="text"
            ...
            {/* Animasi filter dengan delay menyambung pencarian */}
            <NativeReveal
              delay={0.1}
              className={`${styles.filters} reveal-slide-up`}
            >
          ...
          <div className={styles.gridInner}>
            {filtered.length === 0 ? (
              ...
              <div className={styles.grid}>
                {filtered.map((p, i) => (
                  /* Setiap kartu memanggil NativeReveal secara mandiri agar delay berfungsi sebagai stagger */
                  <NativeReveal
                    key={p.slug}
                    delay={i * 0.1}
